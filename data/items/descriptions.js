...
const watchDescription = `
  ...
  <ul>
    <li>
      <span>
        Case size: 40 millimeters, Bandwidth: 21 millimeters, Case Thickness:
        11.5 millimeters. The diameter is 25.6 millimeters; Lugs 21 ; Dial :
        HMSD
      </span>
    </li>
  </ul>
  <ul>
    <li>
      <span>
        Swiss automatic movement, 316L Stainless Steel case, scratch-resistant
        sapphire crystal, Indexes dial Type, date
      </span>
    </li>
  </ul>
  <ul>
    <li>
      <span>Stainless steel bracelet, butterfly clasp with push-button</span>
    </li>
  </ul>
  <ul>
    <li>
      <span>
        Water-resistant up to a pressure of 10 bar (100 m/330 Feet): Suitable
        for short periods of recreational swimillimetersing and showering, but
        not diving or snorkeling
      </span>
    </li>
  </ul>
`;

module.exports = { airpodsDescription, airtagDescription, xboxDescription, watchDescription };
